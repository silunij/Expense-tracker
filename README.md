...
## An App that can track a user's expenses and provide reports

- **What will the application do?**
   *A user can enter their spendings daily and save and keep track of them. 
   The user can assign a monthly and daily budget amount for different categories like food, cloths etc and it can give a warning if the budget for a given month is exceeded.
   It could also provide a monthly reports on what category most money is spent on and what day of the week. Recurring payments such as phone bill will automatically be added to the monthly list without the user having to enter them manually.*
- **Who will use it?**
    *Mostly students who try to keep track of their money*
...
- You can locate my visual component after adding an expense. (add expense by clicking on the add expense button) after the expense is added a progress bar will pop up which is the visual component. it shows the percentage of the budget used for the newly added expense.
- You can save the state of my application by going to file in the menu bar at the top and selecting save
- You can reload the state of my application by going to file in the menu bar at the top and selecting load
